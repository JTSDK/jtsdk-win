...
InfoBeforeFile={#SvnPrefix}\trunk\installers\jtsdk_u3_before_install.txt
...
[Files]
Source: "{#BuildPrefix}\Ruby\*"; DestDir: "{app}\Ruby"; Flags: ignoreversion recursesubdirs createallsubdirs

[Messages]
WelcomeLabel1=JTSDK Update (Install Ruby + AsciiDoctor)
SetupAppTitle=JTSDK Update ( Install Ruby + AsciiDoctor )
SetupWindowTitle=JTSDK Update ( Install Ruby + AsciiDoctor )
FinishedHeadingLabel=Finished JTSDK Update
